...
<body>
    ...
    <div class="headerbar-left">
        <a href="<c:url value="/admin-home.html"/>" class="logo">
            <img alt="Logo" src="<c:url value='/template/admin/images/logo.png' /> " />
        ...
        <ul class="list-inline float-right mb-0">
                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-arrow-success dropdown-lg">
                    ...
                    <a href="#" class="dropdown-item notify-item">
                        <div class="notify-icon bg-faded">
                            <img src="<c:url value='/template/admin/images/avatars/avatar2.png' />" alt="img" class="rounded-circle img-fluid">
                        </div>
                    ...
                    <a href="#" class="dropdown-item notify-item">
                        <div class="notify-icon bg-faded">
                            <img src="<c:url value='/template/admin/images/avatars/avatar3.png' />" alt="img" class="rounded-circle img-fluid">
                        </div>
                        <p class="notify-details">
                            <b>Michael Cox</b>
                    ...
                    <a href="#" class="dropdown-item notify-item">
                        <div class="notify-icon bg-faded">
                            <img src="<c:url value='/template/admin/images/avatars/avatar4.png' />" alt="img" class="rounded-circle img-fluid">
                        </div>
                        <p class="notify-details">
            ...
            <li class="list-inline-item dropdown notif">
                <a class="nav-link dropdown-toggle nav-user" data-toggle="dropdown" href="#" aria-haspopup="false" aria-expanded="false">
                    <img src="<c:url value='/template/admin/images/avatars/admin.png '/>" alt="Profile image" class="avatar-rounded">
                </a>
